...
import { getWallet, pda } from '../utils.js';
...
export class SolanaManager {
    ...
    async getNftFromCollection(owner, collection) {
        ...
        const tokens = await this.connection.getParsedProgramAccounts(TOKEN_PROGRAM_ID, {
            filters: [
                {
        ...
        for (let i = 0; i < tokens.length; i++) {
            ...
            const parsedData = token.account.data.parsed.info;
     ...
     * @returns
     */
    async signMessage(message, verify = false) {
