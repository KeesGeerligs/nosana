...
(function (OpenApiV3Converter) {
    OpenApiV3Converter.convert = function (input) {
        var _a;
        return (__assign(__assign({}, input), { components: OpenApiV3Converter.convertComponents((_a = input.components) !== null && _a !== void 0 ? _a : {}), paths: input.paths
    ...
    var convertParameter = function (components) {
        return function (input) { return (__assign(__assign({}, input), { schema: OpenApiV3Converter.convertSchema(components)(input.schema), examples: input.examples
        ...
        return function (input) {
            ...
            var visit = function (schema) {
                ...
                // INSTANCE TYPE CASE
                    ...
                    union.push(__assign(__assign({}, schema), { items: OpenApiV3Converter.convertSchema(components)(schema.items) }));
    ...
    var convertAllOfSchema = function (components) {
        return function (input) {
            ...
            return __assign(__assign(__assign({}, input), { type: "object", properties: Object.fromEntries(objects
                    ...
                    .map(function (_a) {
                    var _b = __read(_a, 2), key = _b[0], value = _b[1];
                    return [key, OpenApiV3Converter.convertSchema(components)(value)];
                })) }), {
                allOf: undefined,
            });
        };
