...
(function (MigrateRouteConverter) {
    MigrateRouteConverter.convert = function (props) {
        var e_1, _a;
        ...
        var success = emplaceBodySchema("response")(function (schema) {
            return emplaceReference({
                document: props.document,
                name: "response",
                schema: schema,
            });
        })((_e = (_c = (_b = props.operation.responses) === null || _b === void 0 ? void 0 : _b["201"]) !== null && _c !== void 0 ? _c : (_d = props.operation.responses) === null || _d === void 0 ? void 0 : _d["200"]) !== null && _e !== void 0 ? _e : (_f = props.operation.responses) === null || _f === void 0 ? void 0 : _f.default);
        var failures = [];
        if (body === false)
        ...
        // HEADERS AND QUERY
        //---
        var _m = __read(["header", "query"].map(function (type) {
            var _a, _b, _c, _d;
        ...
        var pathParameters = ((_g = props.operation.parameters) !== null && _g !== void 0 ? _g : []).filter(function (p) { return p.in === "path"; });
        if (parameterNames.length !== pathParameters.length)
            if (pathParameters.length < parameterNames.length &&
                ...
                props.operation.parameters = __spreadArray(__spreadArray([], __read(pathParameters), false), __read(((_h = props.operation.parameters) !== null && _h !== void 0 ? _h : []).filter(function (p) { return p.in !== "path"; })), false);
            }
            else
                failures.push("number of path parameters are not matched with its full path.");
        if (failures.length)
            return failures;
        var parameters = ((_j = props.operation.parameters) !== null && _j !== void 0 ? _j : [])
        ...
        return {
            ...
            accessor: ["@lazy"],
            parameters: ((_k = props.operation.parameters) !== null && _k !== void 0 ? _k : [])
                .filter(function (p) { return p.in === "path"; })
                .map(function (p, i) { return ({
                // FILL KEY NAME IF NOT EXISTsS
                name: parameterNames[i],
...
})(MigrateRouteConverter || (exports.MigrateRouteConverter = MigrateRouteConverter = {}));
