 ...
 */
export type ILlmSchema = ILlmSchema.IBoolean | ILlmSchema.IInteger | ILlmSchema.INumber | ILlmSchema.IString | ILlmSchema.IArray | ILlmSchema.IObject | ILlmSchema.IUnknown | ILlmSchema.INullOnly | ILlmSchema.IOneOf;
export declare namespace ILlmSchema {
     ...
     */
    interface IArray<Schema extends ILlmSchema = ILlmSchema> extends __ISignificant<"array"> {
        /**
     ...
     */
    interface IObject<Schema extends ILlmSchema = ILlmSchema> extends __ISignificant<"object"> {
        /**
     ...
     */
    interface IOneOf<Schema extends ILlmSchema = ILlmSchema> extends __IAttribute {
        /**
