...
import { OpenApiV3Converter } from "./converters/OpenApiV3Converter.mjs";

import { OpenApiV3Downgrader } from "./converters/OpenApiV3Downgrader.mjs";

import { OpenApiV3_1Converter } from "./converters/OpenApiV3_1Converter.mjs";

import { SwaggerV2Converter } from "./converters/SwaggerV2Converter.mjs";
...
(function(OpenApi) {
    function convert(input) {
        if (OpenApiV3_1.is(input)) return OpenApiV3_1Converter.convert(input); else if (OpenApiV3.is(input)) return OpenApiV3Converter.convert(input); else if (SwaggerV2.is(input)) return SwaggerV2Converter.convert(input);
