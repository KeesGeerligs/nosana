...
function transformSchemaObjectCore(schemaObject, options) {
  ...
  if ("properties" in schemaObject && schemaObject.properties && Object.keys(schemaObject.properties).length || "additionalProperties" in schemaObject && schemaObject.additionalProperties || "$defs" in schemaObject && schemaObject.$defs) {
    ...
    if (schemaObject.additionalProperties || options.ctx.additionalProperties) {
      ...
      let addlType = hasExplicitAdditionalProperties ? transformSchemaObject(schemaObject.additionalProperties, options) : UNKNOWN;
...
async function openapiTS(source, options = {}) {
  ...
  const ctx = {
    ...
    excludeDeprecated: (_k = options.excludeDeprecated) != null ? _k : false,
    exportType: (_l = options.exportType) != null ? _l : false,
    immutable: (_m = options.immutable) != null ? _m : false,
    injectFooter: [],
    pathParamsAsTypes: (_n = options.pathParamsAsTypes) != null ? _n : false,
    postTransform: typeof options.postTransform === "function" ? options.postTransform : void 0,
    propertiesRequiredByDefault: (_o = options.propertiesRequiredByDefault) != null ? _o : false,
    redoc,
    silent: (_p = options.silent) != null ? _p : false,
    inject: (_q = options.inject) != null ? _q : void 0,
