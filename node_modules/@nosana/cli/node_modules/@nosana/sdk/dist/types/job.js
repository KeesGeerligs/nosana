...
export const validateJobDefinition = (() => { const $join = typia.createValidateEquals.join; const $io0 = (input, _exceptionable = true) => "string" === typeof input.version && "container" === input.type && (undefined === input.meta || "object" === typeof input.meta && null !== input.meta && false === Array.isArray(input.meta) && $io1(input.meta, true && _exceptionable)) && (undefined === input.global || "object" === typeof input.global && null !== input.global && false === Array.isArray(input.global) && $io2(input.global, true && _exceptionable)) && (Array.isArray(input.ops) && input.ops.every((elem, _index1) => "object" === typeof elem && null !== elem && $io4(elem, true && _exceptionable))) && (3 === Object.keys(input).length || Object.keys(input).every(key => {
    ...
    if (undefined !== input.image)
        ...
        value: elem
    })) && $vo4(elem, _path + ".ops[" + _index11 + "]", true && _exceptionable) || $report(_exceptionable, {
        path: _path + ".ops[" + _index11 + "]",
        expected: "Operation<keyof OperationArgsMap>",
        value: elem
        ...
        value: elem
    })) && $vu0(elem, _path + ".resources[" + _index15 + "]", true && _exceptionable) || $report(_exceptionable, {
        path: _path + ".resources[" + _index15 + "]",
        expected: "(S3Secure | S3Unsecure)",
        value: elem
    })).every(flag => flag) || $report(_exceptionable, {
        ...
        expected: "__type.o6",
        value: elem
    })) && $vo9(elem, _path + ".buckets[" + _index17 + "]", true && _exceptionable) || $report(_exceptionable, {
        path: _path + ".buckets[" + _index17 + "]",
        expected: "__type.o6",
        value: elem
    })).every(flag => flag) || $report(_exceptionable, {
        ...
        expected: "__type.o6",
        value: elem
    })) && $vo9(elem, _path + ".buckets[" + _index20 + "]", true && _exceptionable) || $report(_exceptionable, {
        path: _path + ".buckets[" + _index20 + "]",
        expected: "__type.o6",
        value: elem
    })).every(flag => flag) || $report(_exceptionable, {
