...
import { ComputeBudgetProgram, Keypair, PublicKey, SendTransactionError, } from '@solana/web3.js';
...
export class Jobs extends SolanaManager {
    ...
    async list(ipfsHash, jobTimeout, market) {
        ...
        try {
            ...
            const tx = await this.jobs.methods.list([...bs58.decode(ipfsHash).subarray(2)], new BN(jobTimeout))
    ...
    async updateMarket(market, updatedData, instructionOnly) {
        ...
        // @ts-ignore
        data.jobExpiration, data.jobPrice, data.jobType, data.nodeStakeMinimum, new BN(7200))
            .preInstructions(preInstructions)
            .accounts({
            market: market,
