...
export declare class Jobs extends SolanaManager {
     ...
     */
    list(ipfsHash: string, jobTimeout: number, market?: PublicKey): Promise<{
        tx: string;
        job: string;
        run: string;
    }>;
     ...
     */
    delist(jobAddress: PublicKey | string): Promise<{
        tx: string;
        job: string;
    }>;
    /**
     ...
     */
    extend(job: PublicKey | string, jobTimeout: number): Promise<{
        tx: string;
        job: string;
    }>;
    /**
     ...
     */
    end(job: PublicKey | string): Promise<{
        tx: string;
        job: string;
    }>;
    /**
     ...
     * @param job Publickey address of the job to fetch
     */
    cleanAdmin(jobAddress: PublicKey | string, instructionOnly?: boolean): Promise<TransactionSignature | TransactionInstruction>;
    /**
    ...
    }, instructionOnly?: boolean): Promise<string | TransactionInstruction>;
    createMarket(data: {
