...
(function (MiscIsPruneProgrammer) {
    MiscIsPruneProgrammer.decompose = function (props) {
        ...
        return {
            functions: __assign(__assign({}, is.functions), prune.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(is.statements), false), __read(prune.statements), false), [
    ...
    MiscIsPruneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = MiscIsPruneProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
