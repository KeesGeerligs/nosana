...
(function (NotationIsGeneralProgrammer) {
    NotationIsGeneralProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            functions: __assign(__assign({}, is.functions), notation.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(is.statements), false), __read(notation.statements), false), [
        ...
        return function (project) {
            return function (modulo) {
                return function (type, name) {
                    ...
                    var result = NotationIsGeneralProgrammer.decompose({
                        rename: rename,
                        project: project,
                        importer: importer,
                        type: type,
