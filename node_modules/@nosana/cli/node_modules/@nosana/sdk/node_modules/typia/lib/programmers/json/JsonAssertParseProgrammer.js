...
(function (JsonAssertParseProgrammer) {
    JsonAssertParseProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            ...
            statements: __spreadArray(__spreadArray([], __read(assert.statements), false), [
            ...
            ], false), undefined, typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("__assert"), undefined, [
    ...
    JsonAssertParseProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name, init) {
                ...
                var result = JsonAssertParseProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
