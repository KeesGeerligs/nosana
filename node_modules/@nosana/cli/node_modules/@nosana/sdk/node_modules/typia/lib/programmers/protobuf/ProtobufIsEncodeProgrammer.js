...
(function (ProtobufIsEncodeProgrammer) {
    ProtobufIsEncodeProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            functions: __assign(__assign({}, is.functions), encode.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(is.statements), false), __read(encode.statements), false), [
    ...
    ProtobufIsEncodeProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = ProtobufIsEncodeProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
