...
(function (MiscValidatePruneProgrammer) {
    MiscValidatePruneProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            functions: __assign(__assign({}, validate.functions), prune.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(validate.statements), false), __read(prune.statements), false), [
    ...
    MiscValidatePruneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = MiscValidatePruneProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
