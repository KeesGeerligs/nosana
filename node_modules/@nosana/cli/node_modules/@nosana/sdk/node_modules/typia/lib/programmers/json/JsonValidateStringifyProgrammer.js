...
(function (JsonValidateStringifyProgrammer) {
    JsonValidateStringifyProgrammer.decompose = function (props) {
        var _a;
        ...
        var stringify = JsonStringifyProgrammer_1.JsonStringifyProgrammer.decompose(__assign(__assign({}, props), { validated: true }));
        return {
            functions: __assign(__assign({}, validate.functions), stringify.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(validate.statements), false), __read(stringify.statements), false), [
    ...
    JsonValidateStringifyProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = JsonValidateStringifyProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
