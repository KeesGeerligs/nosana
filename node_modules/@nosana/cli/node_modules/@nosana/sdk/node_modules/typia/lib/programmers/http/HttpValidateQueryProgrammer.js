...
exports.HttpValidateQueryProgrammer = void 0;
...
(function (HttpValidateQueryProgrammer) {
    HttpValidateQueryProgrammer.decompose = function (props) {
        var _a;
    ...
    HttpValidateQueryProgrammer.write = function (project) {
        return function (modulo, allowOptional) {
            ...
            return function (type, name) {
                ...
                var result = HttpValidateQueryProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
...
})(HttpValidateQueryProgrammer || (exports.HttpValidateQueryProgrammer = HttpValidateQueryProgrammer = {}));
