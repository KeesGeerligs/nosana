...
(function (MiscAssertCloneProgrammer) {
    MiscAssertCloneProgrammer.decompose = function (props) {
        ...
        return {
            functions: __assign(__assign({}, assert.functions), clone.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(assert.statements), false), __read(clone.statements), false), [
    ...
    MiscAssertCloneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name, init) {
                ...
                var result = MiscAssertCloneProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
