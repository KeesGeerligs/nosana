...
(function (MiscIsCloneProgrammer) {
    MiscIsCloneProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            functions: __assign(__assign({}, is.functions), clone.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(is.statements), false), __read(clone.statements), false), [
    ...
    MiscIsCloneProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = MiscIsCloneProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
