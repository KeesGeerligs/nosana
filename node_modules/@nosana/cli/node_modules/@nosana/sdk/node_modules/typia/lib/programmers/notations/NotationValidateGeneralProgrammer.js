...
(function (NotationValidateGeneralProgrammer) {
    NotationValidateGeneralProgrammer.decompose = function (props) {
        var _a;
        ...
        return {
            functions: __assign(__assign({}, validate.functions), notation.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(validate.statements), false), __read(notation.statements), false), [
        ...
        return function (project) {
            return function (modulo) {
                return function (type, name) {
                    ...
                    var result = NotationValidateGeneralProgrammer.decompose({
                        rename: rename,
                        project: project,
                        modulo: modulo,
                        importer: importer,
