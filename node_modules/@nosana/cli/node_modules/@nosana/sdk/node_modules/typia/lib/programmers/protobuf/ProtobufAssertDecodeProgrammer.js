...
(function (ProtobufAssertDecodeProgrammer) {
    ProtobufAssertDecodeProgrammer.decompose = function (props) {
        ...
        return {
            ...
            arrow: typescript_1.default.factory.createArrowFunction(undefined, undefined, __spreadArray(__spreadArray([], __read(decode.arrow.parameters), false), [
                AssertProgrammer_1.AssertProgrammer.Guardian.parameter(props.init),
            ], false), decode.arrow.type, undefined, typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("__assert"), undefined, [
    ...
    ProtobufAssertDecodeProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name, init) {
                ...
                var result = ProtobufAssertDecodeProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
