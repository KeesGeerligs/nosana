...
exports.HttpValidateHeadersProgrammer = void 0;
...
(function (HttpValidateHeadersProgrammer) {
    HttpValidateHeadersProgrammer.decompose = function (props) {
        var _a;
    ...
    HttpValidateHeadersProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = HttpValidateHeadersProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
...
})(HttpValidateHeadersProgrammer || (exports.HttpValidateHeadersProgrammer = HttpValidateHeadersProgrammer = {}));
