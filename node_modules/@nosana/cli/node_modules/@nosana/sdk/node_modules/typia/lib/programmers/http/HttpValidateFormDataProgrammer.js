...
(function (HttpValidateFormDataProgrammer) {
    HttpValidateFormDataProgrammer.decompose = function (props) {
        var _a;
    ...
    HttpValidateFormDataProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                var importer = new FunctionImporter_1.FunctionImporter(modulo.getText());
                var result = HttpValidateFormDataProgrammer.decompose({
                    project: project,
                    modulo: modulo,
                    importer: importer,
                    type: type,
