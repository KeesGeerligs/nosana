...
(function (HttpQueryProgrammer) {
    ...
    HttpQueryProgrammer.decompose = function (props) {
        var _a;
        // ANALYZE TYPE
        ...
        var result = MetadataFactory_1.MetadataFactory.analyze(props.project.checker, props.project.context)({
            ...
            constant: true,
            absorb: true,
            validate: function (meta, explore) { return HttpQueryProgrammer.validate(meta, explore, props.allowOptional); },
    ...
    HttpQueryProgrammer.write = function (project) {
        return function (modulo, allowOptional) {
            ...
            return function (type, name) {
                ...
                var result = HttpQueryProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
