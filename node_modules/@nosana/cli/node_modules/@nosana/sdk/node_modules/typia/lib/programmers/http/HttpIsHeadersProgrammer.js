...
(function (HttpIsHeadersProgrammer) {
    HttpIsHeadersProgrammer.decompose = function (props) {
        var _a;
        ...
        var decode = HttpHeadersProgrammer_1.HttpHeadersProgrammer.decompose(props);
        return {
    ...
    HttpIsHeadersProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                ...
                var result = HttpIsHeadersProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
