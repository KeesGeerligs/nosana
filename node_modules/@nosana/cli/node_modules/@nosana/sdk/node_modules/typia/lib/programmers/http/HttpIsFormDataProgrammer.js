...
(function (HttpIsFormDataProgrammer) {
    HttpIsFormDataProgrammer.decompose = function (props) {
        var _a;
        ...
        var decode = HttpFormDataProgrammer_1.HttpFormDataProgrammer.decompose(props);
        return {
            functions: __assign(__assign({}, is.functions), decode.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(is.statements), false), __read(decode.statements), false), [
            ...
            arrow: typescript_1.default.factory.createArrowFunction(undefined, undefined, decode.arrow.parameters, typescript_1.default.factory.createUnionTypeNode([
                ...
                StatementFactory_1.StatementFactory.constant("value", typescript_1.default.factory.createCallExpression(typescript_1.default.factory.createIdentifier("__decode"), undefined, [typescript_1.default.factory.createIdentifier("input")])),
    ...
    HttpIsFormDataProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                ...
                var result = HttpIsFormDataProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
