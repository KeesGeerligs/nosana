...
(function (JsonAssertStringifyProgrammer) {
    JsonAssertStringifyProgrammer.decompose = function (props) {
        ...
        return {
            functions: __assign(__assign({}, assert.functions), stringify.functions),
            statements: __spreadArray(__spreadArray(__spreadArray([], __read(assert.statements), false), __read(stringify.statements), false), [
    ...
    JsonAssertStringifyProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name, init) {
                ...
                var result = JsonAssertStringifyProgrammer.decompose({
                    project: project,
                    importer: importer,
                    type: type,
                    name: name,
