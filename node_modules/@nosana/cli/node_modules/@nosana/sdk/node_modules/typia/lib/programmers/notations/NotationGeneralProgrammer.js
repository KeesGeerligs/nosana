...
(function (NotationGeneralProgrammer) {
    ...
    NotationGeneralProgrammer.decompose = function (props) {
        var _a;
        var config = configure(props.rename)(props.project)(props.importer);
        ...
        return {
            ...
            arrow: typescript_1.default.factory.createArrowFunction(undefined, undefined, composed.parameters, typescript_1.default.factory.createTypeReferenceNode(NotationGeneralProgrammer.returnType(props.rename)((_a = props.name) !== null && _a !== void 0 ? _a : TypeFactory_1.TypeFactory.getFullName(props.project.checker)(props.type))), undefined, composed.body),
        };
    };
        ...
        return function (project) {
            return function (modulo) {
                return function (type, name) {
                    ...
                    var result = NotationGeneralProgrammer.decompose({
                        rename: rename,
                        validated: true,
                        project: project,
                        importer: importer,
