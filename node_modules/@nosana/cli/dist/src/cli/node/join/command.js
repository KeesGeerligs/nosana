...
import { gpuOption, networkOption, rpcOption, walletOption, } from '../../sharedOptions/index.js';
export const joinCommand = new Command('join')
    ...
    .default('podman'))
    .addOption(new Option('--docker, --podman <URI>', 'Podman/Docker connection URI').default('http://localhost:8080'))
