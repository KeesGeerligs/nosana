...
export async function postStopJobServiceURLWithRetry(nodeAddress, jobAddress, callback, overrides) {
    let retryCount = 0;
    ...
    const intervalId = setInterval(async () => {
        ...
        try {
            const response = await fetch(`https://${nodeAddress}.${configs().frp.serverAddr}/service/stop/${jobAddress}`, {
                method: 'POST',
                headers,
                body: '',
            });
