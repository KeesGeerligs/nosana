...
export async function verifyWSNodeOrJobOwnerSignatureMiddleware(ws, headers, body, nextFunction) {
    const sdk = getSDK();
    ...
    try {
        ...
        try {
            if (sdk.authorization.validate(headers, {
        ...
        ws.close(401, `Unathorized Request: ${error.message}`);
    }
}
