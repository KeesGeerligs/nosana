export declare const NODE_STATE_NAME: {
    readonly NODE_STARTING: "NODE_STARTING";
    readonly NODE_STARTED: "NODE_STARTED";
    readonly PROVIDER_HEALTH_CHECKING: "PROVIDER_HEALTH_CHECKING";
    readonly PROVIDER_HEALTH_PASSED: "PROVIDER_HEALTH_PASSED";
    readonly PROVIDER_HEALTH_FAILED: "PROVIDER_HEALTH_FAILED";
    readonly API_SERVER_STARTING: "API_SERVER_STARTING";
    readonly API_SERVER_STARTED: "API_SERVER_STARTED";
    readonly API_SERVER_FAILED: "API_SERVER_FAILED";
    readonly HEALTH_CHECK_STARTING: "HEALTH_CHECK_STARTING";
    readonly HEALTH_CHECK_RUNNING: "HEALTH_CHECK_RUNNING";
    readonly HEALTH_CHECK_PASSED: "HEALTH_CHECK_PASSED";
    readonly HEALTH_CHECK_FAILED: "HEALTH_CHECK_FAILED";
    readonly BENCHMARK_STARTING: "BENCHMARK_STARTING";
    readonly BENCHMARK_RUNNING: "BENCHMARK_RUNNING";
    readonly BENCHMARK_PASSED: "BENCHMARK_PASSED";
    readonly BENCHMARK_FAILED: "BENCHMARK_FAILED";
    readonly RETRIVING_MARKET: "RETRIVING_MARKET";
    readonly RETRIVING_MARKET_PASSED: "RETRIVING_MARKET_PASSED";
    readonly RETRIVING_MARKET_FAILED: "RETRIVING_MARKET_FAILED";
    readonly JOINING_QUEUE: "JOINING_QUEUE";
    readonly JOINED_QUEUE: "JOINED_QUEUE";
    readonly JOINING_QUEUE_PASSED: "JOINING_QUEUE_PASSED";
    readonly JOINING_QUEUE_FAILED: "JOINING_QUEUE_FAILED";
    readonly JOB_STARTING: "JOB_STARTING";
    readonly JOB_STARTING_PASSED: "JOB_STARTING_PASSED";
    readonly JOB_STARTING_FAILED: "JOB_STARTING_FAILED";
    readonly JOB_RUNNING: "JOB_RUNNING";
    readonly JOB_COMPLETED: "JOB_COMPLETED";
    readonly JOB_STOPPED: "JOB_STOPPED";
