...
const outputEventsMock = {
    ...
    [OUTPUT_EVENTS.OUTPUT_PRIVATE_URL_MESSAGE]: jest.fn(),
    ...
    [OUTPUT_EVENTS.OUTPUT_JOB_URL_ERROR]: jest.fn(),
    [OUTPUT_EVENTS.OUTPUT_JOB_URL_EXPIRED]: jest.fn(),
    [OUTPUT_EVENTS.OUTPUT_JOB_URL_NOT_READY]: jest.fn(),
    [OUTPUT_EVENTS.OUTPUT_JOB_INVALID]: jest.fn(),
    [OUTPUT_EVENTS.OUTPUT_JOB_SERVICE_URL]: jest.fn(),
};
