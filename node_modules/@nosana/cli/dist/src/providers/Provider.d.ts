...
export declare const validateJobDefinition: (input: unknown) => typia.IValidation<JobDefinition>;
...
export declare abstract class Provider {
    ...
    abstract stopFlowOperation(flowId: string, op: Operation<OperationType>): Promise<OpState>;
    abstract finishFlow(flowId: string, status?: string): void;
    abstract waitForFlowFinish(id: string, logCallback?: Function): Promise<FlowState | null>;
