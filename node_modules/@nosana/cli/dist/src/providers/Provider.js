...
export const validateJobDefinition = input => {
    const errors = [];
    const __is = (input, _exceptionable = true) => {
        const $join = typia.createValidateEquals.join;
        const $io0 = (input, _exceptionable = true) => "string" === typeof input.version && "container" === input.type && (undefined === input.logicstics || "object" === typeof input.logicstics && null !== input.logicstics && false === Array.isArray(input.logicstics) && $io1(input.logicstics, true && _exceptionable)) && (undefined === input.meta || "object" === typeof input.meta && null !== input.meta && false === Array.isArray(input.meta) && $io6(input.meta, true && _exceptionable)) && (undefined === input.global || "object" === typeof input.global && null !== input.global && false === Array.isArray(input.global) && $io7(input.global, true && _exceptionable)) && (Array.isArray(input.ops) && input.ops.every((elem, _index1) => "object" === typeof elem && null !== elem && $io9(elem, true && _exceptionable))) && (3 === Object.keys(input).length || Object.keys(input).every(key => {
            if (["version", "type", "logicstics", "meta", "global", "ops"].some(prop => key === prop))
                return true;
        ...
        const $io1 = (input, _exceptionable = true) => (undefined === input.send || "object" === typeof input.send && null !== input.send && $io2(input.send, true && _exceptionable)) && (undefined === input.receive || "object" === typeof input.receive && null !== input.receive && $io4(input.receive, true && _exceptionable)) && (0 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io2 = (input, _exceptionable = true) => ("api" === input.type || "api-listen" === input.type) && ("object" === typeof input.args && null !== input.args && false === Array.isArray(input.args) && $io3(input.args, true && _exceptionable)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io3 = (input, _exceptionable = true) => (undefined === input.endpoint || "string" === typeof input.endpoint) && (0 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io4 = (input, _exceptionable = true) => ("api" === input.type || "api-listen" === input.type) && ("object" === typeof input.args && null !== input.args && false === Array.isArray(input.args) && $io5(input.args, true && _exceptionable)) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
            if (["type", "args"].some(prop => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
        ...
        const $io5 = (input, _exceptionable = true) => (undefined === input.endpoint || "string" === typeof input.endpoint) && (0 === Object.keys(input).length || Object.keys(input).every(key => {
            if (["endpoint"].some(prop => key === prop))
                return true;
            const value = input[key];
            if (undefined === value)
        ...
        const $io6 = (input, _exceptionable = true) => (undefined === input.trigger || "string" === typeof input.trigger) && (0 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io7 = (input, _exceptionable = true) => (undefined === input.image || "string" === typeof input.image) && (undefined === input.gpu || "boolean" === typeof input.gpu) && (null !== input.entrypoint && (undefined === input.entrypoint || "string" === typeof input.entrypoint || Array.isArray(input.entrypoint) && input.entrypoint.every((elem, _index2) => "string" === typeof elem))) && (undefined === input.env || "object" === typeof input.env && null !== input.env && false === Array.isArray(input.env) && $io8(input.env, true && _exceptionable)) && (undefined === input.work_dir || "string" === typeof input.work_dir) && (0 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io8 = (input, _exceptionable = true) => Object.keys(input).every(key => {
            const value = input[key];
            if (undefined === value)
                return true;
            return "string" === typeof value;
        });
        const $io9 = (input, _exceptionable = true) => ("container/run" === input.type || "container/create-volume" === input.type) && "string" === typeof input.id && ("object" === typeof input.args && null !== input.args && $iu1(input.args, true && _exceptionable)) && (undefined === input.results || "object" === typeof input.results && null !== input.results && false === Array.isArray(input.results) && $io18(input.results, true && _exceptionable)) && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io10 = (input, _exceptionable = true) => "string" === typeof input.image && (null !== input.cmd && (undefined === input.cmd || "string" === typeof input.cmd || Array.isArray(input.cmd) && input.cmd.every((elem, _index3) => "string" === typeof elem))) && (undefined === input.volumes || Array.isArray(input.volumes) && (input.volumes.length === 1 && ("object" === typeof input.volumes[0] && null !== input.volumes[0] && $io11(input.volumes[0], true && _exceptionable)))) && (undefined === input.expose || "number" === typeof input.expose) && (undefined === input.private || "boolean" === typeof input.private) && (undefined === input.gpu || "boolean" === typeof input.gpu) && (undefined === input.work_dir || "string" === typeof input.work_dir) && (undefined === input.output || "string" === typeof input.output) && (null !== input.entrypoint && (undefined === input.entrypoint || "string" === typeof input.entrypoint || Array.isArray(input.entrypoint) && input.entrypoint.every((elem, _index4) => "string" === typeof elem))) && (undefined === input.env || "object" === typeof input.env && null !== input.env && false === Array.isArray(input.env) && $io12(input.env, true && _exceptionable)) && (undefined === input.resources || Array.isArray(input.resources) && input.resources.every((elem, _index5) => "object" === typeof elem && null !== elem && $iu0(elem, true && _exceptionable))) && (1 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io11 = (input, _exceptionable = true) => "string" === typeof input.name && "string" === typeof input.dest && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io12 = (input, _exceptionable = true) => Object.keys(input).every(key => {
            const value = input[key];
            if (undefined === value)
                return true;
            return "string" === typeof value;
        });
        const $io13 = (input, _exceptionable = true) => "S3" === input.type && (undefined === input.url || "string" === typeof input.url) && "string" === typeof input.target && (undefined === input.files || Array.isArray(input.files) && input.files.every((elem, _index6) => "string" === typeof elem)) && (undefined === input.allowWrite || "boolean" === typeof input.allowWrite) && (undefined === input.buckets || Array.isArray(input.buckets) && input.buckets.every((elem, _index7) => "object" === typeof elem && null !== elem && $io14(elem, true && _exceptionable))) && (2 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io14 = (input, _exceptionable = true) => "string" === typeof input.url && (undefined === input.files || Array.isArray(input.files) && input.files.every((elem, _index8) => "string" === typeof elem)) && (1 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io16 = (input, _exceptionable = true) => "string" === typeof input.REGION && "string" === typeof input.ACCESS_KEY_ID && "string" === typeof input.SECRET_ACCESS_KEY && (3 === Object.keys(input).length || Object.keys(input).every(key => {
        ...
        const $io17 = (input, _exceptionable = true) => "string" === typeof input.name && (1 === Object.keys(input).length || Object.keys(input).every(key => {
    ...
    if (false === __is(input)) {
        ...
        ((input, _path, _exceptionable = true) => {
            ...
            const $vo0 = (input, _path, _exceptionable = true) => ["string" === typeof input.version || $report(_exceptionable, {
                    ...
                    expected: "\"container\"",
                    value: input.type
                }), undefined === input.logicstics || ("object" === typeof input.logicstics && null !== input.logicstics && false === Array.isArray(input.logicstics) || $report(_exceptionable, {
                    path: _path + ".logicstics",
                    expected: "(JobLogicstics | undefined)",
                    value: input.logicstics
                })) && $vo1(input.logicstics, _path + ".logicstics", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".logicstics",
                    expected: "(JobLogicstics | undefined)",
                    value: input.logicstics
                    ...
                    value: input.meta
                })) && $vo6(input.meta, _path + ".meta", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".meta",
                    expected: "(__type.o2 | undefined)",
                    value: input.meta
                    ...
                    value: input.global
                })) && $vo7(input.global, _path + ".global", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".global",
                    expected: "(__type.o3 | undefined)",
                    value: input.global
                    ...
                    value: elem
                })) && $vo9(elem, _path + ".ops[" + _index1 + "]", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".ops[" + _index1 + "]",
                    expected: "Operation<keyof OperationArgsMap>",
                    value: elem
            ...
            const $vo1 = (input, _path, _exceptionable = true) => [undefined === input.send || ("object" === typeof input.send && null !== input.send || $report(_exceptionable, {
                    path: _path + ".send",
                    expected: "(SendJobDefinationLogicstics | undefined)",
                    value: input.send
                })) && $vo2(input.send, _path + ".send", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".send",
                    expected: "(SendJobDefinationLogicstics | undefined)",
                    value: input.send
                }), undefined === input.receive || ("object" === typeof input.receive && null !== input.receive || $report(_exceptionable, {
                    path: _path + ".receive",
                    expected: "(ReceiveJobResultLogicstics | undefined)",
                    value: input.receive
                })) && $vo4(input.receive, _path + ".receive", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".receive",
                    expected: "(ReceiveJobResultLogicstics | undefined)",
                    value: input.receive
            ...
            const $vo2 = (input, _path, _exceptionable = true) => ["api" === input.type || "api-listen" === input.type || $report(_exceptionable, {
                    path: _path + ".type",
                    expected: "(\"api\" | \"api-listen\")",
                    value: input.type
                }), ("object" === typeof input.args && null !== input.args && false === Array.isArray(input.args) || $report(_exceptionable, {
                    path: _path + ".args",
                    expected: "__type",
                    value: input.args
                })) && $vo3(input.args, _path + ".args", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".args",
                    expected: "__type",
                    value: input.args
            ...
            const $vo3 = (input, _path, _exceptionable = true) => [undefined === input.endpoint || "string" === typeof input.endpoint || $report(_exceptionable, {
                    path: _path + ".endpoint",
            ...
            const $vo4 = (input, _path, _exceptionable = true) => ["api" === input.type || "api-listen" === input.type || $report(_exceptionable, {
                    path: _path + ".type",
                    expected: "(\"api\" | \"api-listen\")",
                    value: input.type
                }), ("object" === typeof input.args && null !== input.args && false === Array.isArray(input.args) || $report(_exceptionable, {
            ...
            const $vo5 = (input, _path, _exceptionable = true) => [undefined === input.endpoint || "string" === typeof input.endpoint || $report(_exceptionable, {
                    path: _path + ".endpoint",
                    expected: "(string | undefined)",
                    value: input.endpoint
                }), 0 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).map(key => {
            ...
            const $vo6 = (input, _path, _exceptionable = true) => [undefined === input.trigger || "string" === typeof input.trigger || $report(_exceptionable, {
                    path: _path + ".trigger",
                    expected: "(string | undefined)",
                    value: input.trigger
                }), 0 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).map(key => {
            ...
            const $vo7 = (input, _path, _exceptionable = true) => [undefined === input.image || "string" === typeof input.image || $report(_exceptionable, {
                    path: _path + ".image",
                    expected: "(string | undefined)",
                    value: input.image
                    ...
                    value: input.env
                })) && $vo8(input.env, _path + ".env", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".env",
                    expected: "(__type.o4 | undefined)",
                    value: input.env
            ...
            const $vo8 = (input, _path, _exceptionable = true) => [false === _exceptionable || Object.keys(input).map(key => {
                    const value = input[key];
                    if (undefined === value)
                        return true;
            ...
            const $vo9 = (input, _path, _exceptionable = true) => ["container/run" === input.type || "container/create-volume" === input.type || $report(_exceptionable, {
                    path: _path + ".type",
                    ...
                    value: input.results
                })) && $vo18(input.results, _path + ".results", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".results",
                    expected: "(OperationResults | undefined)",
                    value: input.results
                }), 3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).map(key => {
            ...
            const $vo10 = (input, _path, _exceptionable = true) => ["string" === typeof input.image || $report(_exceptionable, {
                    path: _path + ".image",
                    expected: "string",
                    value: input.image
                    ...
                    })) && $vo11(input.volumes[0], _path + ".volumes[0]", true && _exceptionable) || $report(_exceptionable, {
                        path: _path + ".volumes[0]",
                        expected: "__type.o6",
                        value: input.volumes[0]
                    })
                    ...
                    value: input.env
                })) && $vo12(input.env, _path + ".env", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".env",
                    expected: "(__type.o7 | undefined)",
                    value: input.env
            ...
            const $vo13 = (input, _path, _exceptionable = true) => ["S3" === input.type || $report(_exceptionable, {
                    path: _path + ".type",
                    expected: "\"S3\"",
                    value: input.type
                    ...
                    expected: "__type.o8",
                    value: elem
                })) && $vo14(elem, _path + ".buckets[" + _index7 + "]", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".buckets[" + _index7 + "]",
                    expected: "__type.o8",
                    value: elem
                })).every(flag => flag) || $report(_exceptionable, {
            ...
            const $vo14 = (input, _path, _exceptionable = true) => ["string" === typeof input.url || $report(_exceptionable, {
                    path: _path + ".url",
                    expected: "string",
                    value: input.url
                }), undefined === input.files || (Array.isArray(input.files) || $report(_exceptionable, {
            ...
            const $vo15 = (input, _path, _exceptionable = true) => ["S3" === input.type || $report(_exceptionable, {
                    path: _path + ".type",
                    expected: "\"S3\"",
                    value: input.type
                }), undefined === input.url || "string" === typeof input.url || $report(_exceptionable, {
                    ...
                    expected: "__type.o8",
                    value: elem
                })) && $vo14(elem, _path + ".buckets[" + _index10 + "]", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".buckets[" + _index10 + "]",
                    expected: "__type.o8",
                    value: elem
                })).every(flag => flag) || $report(_exceptionable, {
                    ...
                    expected: "S3Auth",
                    value: input.IAM
                })) && $vo16(input.IAM, _path + ".IAM", true && _exceptionable) || $report(_exceptionable, {
                    path: _path + ".IAM",
                    expected: "S3Auth",
                    value: input.IAM
                }), 3 === Object.keys(input).length || (false === _exceptionable || Object.keys(input).map(key => {
            ...
            const $vo16 = (input, _path, _exceptionable = true) => ["string" === typeof input.REGION || $report(_exceptionable, {
                    path: _path + ".REGION",
                    expected: "string",
                    value: input.REGION
            ...
            const $vo18 = (input, _path, _exceptionable = true) => [false === _exceptionable || Object.keys(input).map(key => {
                    ...
                    return (null !== value || $report(_exceptionable, {
                        ...
                        expected: "(OperationResult | string)",
                        value: value
                    })) && $vo19(value, _path + $join(key), true && _exceptionable) || $report(_exceptionable, {
                        path: _path + $join(key),
                        expected: "(OperationResult | string)",
                        value: value
                    }));
                }).every(flag => flag)].every(flag => flag);
            const $vo19 = (input, _path, _exceptionable = true) => ["string" === typeof input.regex || $report(_exceptionable, {
                    path: _path + ".regex",
                    expected: "string",
                    value: input.regex
