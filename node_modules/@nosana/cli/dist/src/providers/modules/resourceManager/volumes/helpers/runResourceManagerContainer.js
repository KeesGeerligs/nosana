...
export async function runResourceManagerContainer(volumeName, resource, docker) {
    const { url, files } = resource;
    const container = await docker.createContainer(createS3HelperOpts(volumeName, { url, files }, resource.IAM));
